...
output_file_path = 'predictions_RoBERTa.csv'  # File to save predictions
performance_file_path = 'performance_metrics_RoBERTa.csv'  # File to save performance metrics
checkpoint_dir = r'C:\Users\chawl\Documents\ClickBait\Model_RoBERTa_Task1\checkpoints'  # Directory to save checkpoints
...
val_texts, val_preds, val_probs, val_labels = get_predictions(roberta_model, val_loader, device)
...
test_texts, test_preds, test_probs = get_predictions(roberta_model, test_loader, device, has_labels=False)
