...
output_file_path = 'predictions_LogisticRegression_RoBERTa.csv'  # File to save predictions
performance_file_path = 'performance_metrics_LogisticRegression_RoBERTa.csv'  # File to save performance metrics
checkpoint_dir = r'C:\Users\chawl\Documents\ClickBait\Model_RoBERT_LR_Task1\checkpoints'  # Directory to save checkpoints
...
# Combine training and validation data for Logistic Regression training
...
# Evaluate the model
val_predictions = logreg_pipeline.predict(val_embeddings)
...
test_predictions = logreg_pipeline.predict(test_embeddings)
